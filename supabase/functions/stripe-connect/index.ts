...
serve(async (req) => {
  ...
  try {
    ...
    const accountLink = await stripe.accountLinks.create({
      account: account.id,
      refresh_url: `https://sadmin.wapizimabeautyschool.com/dashboard?error=true`,
      return_url: `https://sadmin.wapizimabeautyschool.com/dashboard?success=true&account_id=${account.id}`,
